...
namespace DatReaderWriter.Tests.DBObjs {
    ...
    public class RenderSurfaceTests {
        ...
        public void CanInsertAndReadTextures() {
            ...
            var texture1 = new RenderSurface() {
                Id = 0x06000001,
                Width = 100,
                Height = 100,
            ...
            var texture2 = new RenderSurface() {
                Id = 0x06000002,
                Width = 100,
                Height = 100,
            ...
            var res2 = dat.TryGet<RenderSurface>(0x06000001, out var readTexture1);
            Assert.IsTrue(res2);
            ...
            res2 = dat.TryGet<RenderSurface>(0x06000002, out var readTexture2);
            Assert.IsTrue(res2);
        ...
        public void CanReadEORTextures() {
            ...
            var res = dat.TryGet<RenderSurface>(0x06000164, out var texture1);
            Assert.IsTrue(res);
            ...
            res = dat.TryGet<RenderSurface>(0x06007364, out var texture2);
            Assert.IsTrue(res);
        ...
        public void CanReadEORAndWriteIdentical() {
            TestHelpers.CanReadAndWriteIdentical<RenderSurface>(Path.Combine(EORCommonData.DatDirectory, $"client_portal.dat"), 0x06000164);
            TestHelpers.CanReadAndWriteIdentical<RenderSurface>(Path.Combine(EORCommonData.DatDirectory, $"client_portal.dat"), 0x06007364);
        }
    }
}
