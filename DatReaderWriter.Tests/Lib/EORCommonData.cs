...
namespace DatReaderWriter.Tests.Lib {
    ...
    internal static class EORCommonData {
        ...
        internal static string DatDirectory = Environment.GetEnvironmentVariable("EOR_DAT_DIR") ?? @"/media/trevis/Backups/ac/dats/EoR";
